...
const pool = new Pool({
  connectionString: process.env.DATABASE_URL_STAGING || process.env.DATABASE_URL,
...
async function runMigration() {
  ...
  try {
    console.log('🔄 Running Migration 044 on Staging: Add is_first_login and failed_login_attempts columns...\n');
    ...
    console.log('\n🎉 Migration 044 completed successfully on Staging!\n');
  } catch (error) {

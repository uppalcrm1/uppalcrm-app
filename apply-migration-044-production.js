...
async function runMigration() {
  ...
  try {
    console.log('🔄 Running Migration 044 on Production: Add is_first_login and failed_login_attempts columns...\n');
    ...
    console.log('\n🎉 Migration 044 completed successfully on Production!\n');
  } catch (error) {

...
// Production database connection - using DATABASE_URL from Render environment
const pool = new Pool({
  connectionString: 'postgresql://uppalcrm_database_user:Gp2H0C3JCO2eQWcmkKZbTHKpE2vQcBXn@dpg-crcvte5ds78s73dpn6k0-a.oregon-postgres.render.com/uppalcrm_database',
  ssl: {

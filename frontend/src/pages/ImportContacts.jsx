...
const ImportContacts = () => {
  ...
  const handleFileUpload = async (file) => {
    ...
    try {
      ...
      formData.append('importType', 'contacts');
      ...
      <div className="mb-8">
        <div className="flex items-center space-x-4 mb-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">Import contacts from a CSV file</p>
          </div>
        </div>
          ...
          <div className="p-6 text-center">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-gray-600 mb-6">
                Your contacts import has been queued for processing. You'll be redirected to the status page to monitor progress.
              </p>
